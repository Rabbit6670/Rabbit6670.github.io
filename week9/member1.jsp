<%@ page language="java" contntType="text/html; charset=UTF-8" pageEncoding="UTF-8">
<% request.setCharacterEncoding("utf-8"); %>
<!doctype html> <!--  member1.jsp -->
<html><head><meta charset="utf-8"/><meta name="viewport" content="width=device-wudth, initial-scale=1"/>
